...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Best Projector provider in Delhi | Top Mobile Charger Manufacturers in Delhi</title>
        ...
        <meta property="og:title" content="Best Projector provider in Delhi | Top Mobile Charger Manufacturers in Delhi" />
